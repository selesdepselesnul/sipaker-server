...
public class DateTimeParser {
    ...
    public static String toUrlFriendly(String dateTime) {
        return dateTime.equals("") ?
                dateTime : LocalDateTime.parse(dateTime, D_T_FORMATTER_READABLE).format(D_T_FORMATTER_URL_FRIENDLY);
    }

    public static String toReadable(String dateTime) {
        return dateTime.equals("") ?
                dateTime : LocalDateTime.parse(dateTime, D_T_FORMATTER_URL_FRIENDLY).format(D_T_FORMATTER_READABLE);
    }
}
